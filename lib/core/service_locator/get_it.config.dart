...
import 'package:neurolotto_admin/core/service_locator/get_it.dart' as _i23;
...
import 'package:neurolotto_admin/features/lottery/lottery_schedule_date_controller.dart'
    as _i16;
import 'package:neurolotto_admin/features/sales/result_controller.dart' as _i17;
import 'package:neurolotto_admin/features/sales/sale_controller.dart' as _i18;
...
import 'package:neurolotto_admin/features/splash/splash_controller.dart'
    as _i19;
import 'package:neurolotto_admin/features/stand/stand_controller.dart' as _i20;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i13.GroupPrizeLotteryController>(
        () => _i13.GroupPrizeLotteryController(gh<_i5.SupabaseClient>()));
    gh.lazySingleton<_i14.LotteryController>(
        () => _i14.LotteryController(gh<_i5.SupabaseClient>()));
    gh.lazySingleton<_i15.LotteryScheduleController>(
        () => _i15.LotteryScheduleController(gh<_i5.SupabaseClient>()));
    gh.lazySingleton<_i16.LotteryScheduleDateController>(
        () => _i16.LotteryScheduleDateController(gh<_i5.SupabaseClient>()));
    gh.lazySingleton<_i17.ResultController>(
        () => _i17.ResultController(gh<_i5.SupabaseClient>()));
    gh.lazySingleton<_i18.SaleController>(
        () => _i18.SaleController(gh<_i5.SupabaseClient>()));
    gh.factory<_i19.SplashController>(
        () => _i19.SplashController(gh<_i5.SupabaseClient>()));
    gh.lazySingleton<_i20.StandController>(
        () => _i20.StandController(gh<_i5.SupabaseClient>()));
    gh.factory<_i21.StandPasswordController>(
        () => _i21.StandPasswordController(gh<_i5.SupabaseClient>()));
    gh.lazySingleton<_i22.StandPrizeLotteryController>(
        () => _i22.StandPrizeLotteryController(gh<_i5.SupabaseClient>()));
    return this;
  }
}
