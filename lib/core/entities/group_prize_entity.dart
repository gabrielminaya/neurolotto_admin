...
part 'group_prize_entity.freezed.dart';
part 'group_prize_entity.g.dart';

@Freezed()
class GroupStandPrizeEntity with _$GroupStandPrizeEntity {
  const factory GroupStandPrizeEntity({
  ...
  }) = _GroupStandPrizeEntity;

  factory GroupStandPrizeEntity.fromJson(Map<String, dynamic> json) => _$GroupStandPrizeEntityFromJson(json);
}
