...
LotteryStandPrizeEntity _$LotteryStandPrizeEntityFromJson(
    Map<String, dynamic> json) {
  return _LotteryStandPrizeEntity.fromJson(json);
}

/// @nodoc
mixin _$LotteryStandPrizeEntity {
  ...
  @JsonKey(ignore: true)
  $LotteryStandPrizeEntityCopyWith<LotteryStandPrizeEntity> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $LotteryStandPrizeEntityCopyWith<$Res> {
  factory $LotteryStandPrizeEntityCopyWith(LotteryStandPrizeEntity value,
          $Res Function(LotteryStandPrizeEntity) then) =
      _$LotteryStandPrizeEntityCopyWithImpl<$Res, LotteryStandPrizeEntity>;
  @useResult
  $Res call(
...
/// @nodoc
class _$LotteryStandPrizeEntityCopyWithImpl<$Res,
        $Val extends LotteryStandPrizeEntity>
    implements $LotteryStandPrizeEntityCopyWith<$Res> {
  _$LotteryStandPrizeEntityCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$LotteryStandPrizeEntityImplCopyWith<$Res>
    implements $LotteryStandPrizeEntityCopyWith<$Res> {
  factory _$$LotteryStandPrizeEntityImplCopyWith(
          _$LotteryStandPrizeEntityImpl value,
          $Res Function(_$LotteryStandPrizeEntityImpl) then) =
      __$$LotteryStandPrizeEntityImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "lotteries") LotteryEntity lottery,
...
/// @nodoc
class __$$LotteryStandPrizeEntityImplCopyWithImpl<$Res>
    extends _$LotteryStandPrizeEntityCopyWithImpl<$Res,
        _$LotteryStandPrizeEntityImpl>
    implements _$$LotteryStandPrizeEntityImplCopyWith<$Res> {
  __$$LotteryStandPrizeEntityImplCopyWithImpl(
      _$LotteryStandPrizeEntityImpl _value,
      $Res Function(_$LotteryStandPrizeEntityImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$LotteryStandPrizeEntityImpl(
      lottery: null == lottery
          ? _value.lottery
          : lottery // ignore: cast_nullable_to_non_nullable
              as LotteryEntity,
...
/// @nodoc
@JsonSerializable()
class _$LotteryStandPrizeEntityImpl implements _LotteryStandPrizeEntity {
  const _$LotteryStandPrizeEntityImpl(
  ...
  factory _$LotteryStandPrizeEntityImpl.fromJson(Map<String, dynamic> json) =>
      _$$LotteryStandPrizeEntityImplFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$LotteryStandPrizeEntityImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$LotteryStandPrizeEntityImplCopyWith<_$LotteryStandPrizeEntityImpl>
      get copyWith => __$$LotteryStandPrizeEntityImplCopyWithImpl<
          _$LotteryStandPrizeEntityImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$LotteryStandPrizeEntityImplToJson(
      this,
    );
  }
}

abstract class _LotteryStandPrizeEntity implements LotteryStandPrizeEntity {
  const factory _LotteryStandPrizeEntity(
  ...
  factory _LotteryStandPrizeEntity.fromJson(Map<String, dynamic> json) =
      _$LotteryStandPrizeEntityImpl.fromJson;
