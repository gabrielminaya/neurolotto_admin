...
part of 'result_lotteries_controller.dart';
...
/// @nodoc
mixin _$ResultLotteriesControllerState {
  ...
  @JsonKey(ignore: true)
  $ResultLotteriesControllerStateCopyWith<ResultLotteriesControllerState>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ResultLotteriesControllerStateCopyWith<$Res> {
  factory $ResultLotteriesControllerStateCopyWith(
          ResultLotteriesControllerState value,
          $Res Function(ResultLotteriesControllerState) then) =
      _$ResultLotteriesControllerStateCopyWithImpl<$Res,
          ResultLotteriesControllerState>;
  @useResult
  $Res call(
      {bool isLoading,
...
/// @nodoc
class _$ResultLotteriesControllerStateCopyWithImpl<$Res,
        $Val extends ResultLotteriesControllerState>
    implements $ResultLotteriesControllerStateCopyWith<$Res> {
  _$ResultLotteriesControllerStateCopyWithImpl(this._value, this._then);
...
class __$$ResultControllerStateImplCopyWithImpl<$Res>
    extends _$ResultLotteriesControllerStateCopyWithImpl<$Res,
...
class _$ResultControllerStateImpl
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ResultLotteriesControllerState(isLoading: $isLoading, isResultLoading: $isResultLoading, failureMessage: $failureMessage, lotteries: $lotteries, results: $results)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'ResultLotteriesControllerState'))
...
abstract class _ResultControllerState
    implements ResultLotteriesControllerState {
