...
@RoutePage()
class StandPrizeFormView extends StatelessWidget {
  StandPrizeFormView({super.key, required this.prize, required this.stand});

  final LotteryStandEntity stand;
  final LotteryStandPrizeEntity prize;
  ...
  Future<void> onSubmit({required BuildContext context}) async {
    ...
    return _standPrizeController.update(
      stand: stand,
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomAppBar(
        child: Row(
          children: [
            Expanded(
              child: _standPrizeController.watch(
